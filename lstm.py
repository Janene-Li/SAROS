...
def train_model(model):
    ...
    model.save("univ1_trace/model/univ1_[{}-{}]_epoch-{}_fattree{}_x{}.h5".format(file_begin, file_end, test_epoch, fattree_k, x))    #os.path.join("DATA","Test" + ".h5")
...
if __name__ == '__main__':
    ...
    for epoch in [test_epoch]:
        ...
        for switch_id in range(switch_num):
            ...
            # predict
            model = load_model("univ1_trace/model/univ1_[{}-{}]_epoch-{}_fattree{}_x{}.h5".format(file_begin, file_end, test_epoch, fattree_k, x))
