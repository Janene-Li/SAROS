...
def train_model(model):
    ...
    model.save("univ1_trace/univ1_[{}-{}]_epoch-{}_fattree{}_x{}_diff.h5".format(file_begin, file_end, test_epoch, fattree_k, x))    #os.path.join("DATA","Test" + ".h5")
...
def draw_pic(testY_all, testPredict, rmse):
    ...
    # 保存图形
    pic_dir = "univ1_trace/univ1_[{}-{}]_fattree{}_x{}/diff_except{}/".format(file_begin, file_end, fattree_k, x, test_epoch)
...
if __name__ == '__main__':
    ...
    for epoch in [test_epoch]:
        ...
        for switch_id in range(switch_num):
            ...
            # predict
            model = load_model("univ1_trace/univ1_[{}-{}]_epoch-{}_fattree{}_x{}_diff.h5".format(file_begin, file_end, test_epoch, fattree_k, x))
