...
def train_model(model):
    ...
    model.save("univ1_trace/model/univ1_[{}-{}]_epoch-{}_fattree{}_x{}_diff.h5".format(file_begin, file_end, test_epoch, fattree_k, x))    #os.path.join("DATA","Test" + ".h5")
...
def draw_pic(testY_all, testPredict, rmse):
    ...
    # 保存图形
    pic_dir = "univ1_trace/model/univ1_[{}-{}]_fattree{}_x{}/diff_except{}/".format(file_begin, file_end, fattree_k, x, test_epoch)
...
def predict(model, testX_all, testY_all):
    # print(testY_all.shape)
...
if __name__ == '__main__':
    ...
    for epoch in dataset_list:
        ...
        for switch_id in range(switch_num):
            ...
            dataframe = pd.read_csv("univ1_trace/univ1_[{}-{}]_epoch{}_fattree{}/x{}_should_max_hash/switch{}.csv".format(file_begin, file_end, time_interval, fattree_k, x, switch_id), usecols=[3]) # , usecols=[2], engine='python', skipfooter=3
    ...
    for epoch in [test_epoch]:
        ...
        for switch_id in range(switch_num):
            ...
            # predict
            model = load_model("univ1_trace/model/univ1_[{}-{}]_epoch-{}_fattree{}_x{}_diff.h5".format(file_begin, file_end, test_epoch, fattree_k, x))
