...
def evaluate_error():
    ...
    error_file_name = save_data_dir + "error_{}_{}.txt".format(algorithm, round(mean_error, 4))
    file = open(error_file_name, "w")
    file.write("{}_error={}".format(algorithm, mean_error))
    print(f"estimated volume mean error% = {mean_error}")
