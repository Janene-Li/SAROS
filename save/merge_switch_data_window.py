...
class physicalNetwork:
    ...
    def estimate_volume(self):
        ...
        logging.info("【TASK1】VOLUME ESTIMATION = {}, actual volume = {}, ERROR = {}; effectice_sampled_packets_num = {}".format(self.estimated_volume, actual_volume, 100 * error, self.effective_x))
...
if __name__ == '__main__':
    ...
    logging.info("【window】: time interval = {}, fattree_k = {}, x = {}, theta = {} over".format(time_interval, fattree_k, x, theta))
    ...
    # save dir
    save_data_dir = "univ1_trace/univ1_[{}-{}]_epoch{}_fattree{}/x{}_theta{}_window/".format(file_begin, file_end, time_interval, fattree_k, x, theta)
