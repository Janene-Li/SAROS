...
if __name__ == '__main__':
    ...
    logging.info("【delta_mean】: time interval = {}, fattree_k = {}, x = {}, theta = {} over".format(time_interval, fattree_k, x, theta))
    ...
    # save dir
    save_data_dir = "univ1_trace/univ1_[{}-{}]_epoch{}_fattree{}/x{}_theta{}_delta_mean/".format(file_begin, file_end, time_interval, fattree_k, x, theta)
